...
//  [x] Successful download (R->M)      (GD_DL)
//  [x] Successful upload (R->M)        (GD_UL)
//  [x] Person arrived (w/ name) (R->M) (GD_ARR)
//  [x] Person departs (id only) (R->M) (GD_DEP)
//  [x] Get next neighbor id (M->R)     (ID_NEXT)
//  [x] Next neighbor id (R->M)         (ID_NEXT)
