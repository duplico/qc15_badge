...
set GENERATED_COMMAND=-c user_files/configs/MSP430FR2422.ccxml -l user_files/settings/generated.ufsettings -s VerifyAfterProgramLoad=2 -e -f -v "user_files/images/qc15_radiomcu.hex" 
set ADDITIONALS=-n 0
