...
set GENERATED_COMMAND=-c user_files/configs/MSP430FR5972.ccxml -l user_files/settings/generated.ufsettings -s VerifyAfterProgramLoad=2 -e -f -v "user_files/images/qc15_main.hex" 
set ADDITIONALS=-n 0
